...
# input_data1 <- 
#     tibble::tibble(
#         drug_name = c("１０％グルコース", "生理食塩液", "20%グルコース"),
#         volume = c(80, 20, NA_real_),
#     ) |> 
#     na.omit() |> 
#     dplyr::mutate(
#         prop = volume / sum(volume)
...
# table1 <- 
#     unit_table |> 
#     dplyr::left_join(comp1, by = "element_name") |> 
#     dplyr::mutate(
#         tot = coef * prop * 60
#     )
#     
...
# table1 |> 
#     dplyr::mutate(
#         proportion = stringr::str_c(round(prop, digit1), " ", unit1),
#         total = stringr::str_c(round(tot, digit2), " ", unit2),
#     ) |> 
#     dplyr::select(
#         Element = display_name, 
...
# table2 <- 
#     unit_table |> 
#     dplyr::left_join(comp2, by = "element_name") |> 
#     dplyr::mutate(
#         tot = coef * prop * 8.2
#     )
# 
...
# table3 <- 
#     unit_table |> 
#     dplyr::left_join(comp3, by = "element_name") |> 
#     dplyr::mutate(
#         tot = coef * prop * 60
#     )
# 
...
# table_all <- 
#     dplyr::bind_rows(
#         table1 |> dplyr::select(element_name, tot),
#         table2 |> dplyr::select(element_name, tot),
#         table3 |> dplyr::select(element_name, tot),
#         .id = "table_number",
#     ) |> 
#     dplyr::group_by(element_name) |> 
#     dplyr::summarise(total = sum(tot)) |> 
#     print()
# 
# 
# unit_table |> 
#     dplyr::left_join(table_all, by = "element_name") |> 
#     dplyr::mutate(overall = stringr::str_c(round(total, digit2), " ", unit2)) |> 
#     dplyr::select(
#         Element = display_name,
#         Dosage = overall
#     )
